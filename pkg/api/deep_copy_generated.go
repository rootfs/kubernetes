...
func init() {
	if err := Scheme.AddGeneratedDeepCopyFuncs(
		...
		DeepCopy_api_AzureDiskVolumeSource,
...
func DeepCopy_api_AzureDiskVolumeSource(in AzureDiskVolumeSource, out *AzureDiskVolumeSource, c *conversion.Cloner) error {
